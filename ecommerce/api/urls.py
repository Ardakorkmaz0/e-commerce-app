...
urlpatterns = [
    ...
    path(
        "seller/products/<slug:slug>/images/",
        SellerImageListCreateView.as_view(),
        name="seller_images",
    ),
    path(
        "seller/products/<slug:slug>/images/<int:pk>/",
        SellerImageDetailView.as_view(),
        name="seller_image_detail",
    ),
    path(
